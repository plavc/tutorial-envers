package net.plavcak.tutorial.tutorial.jpa.versioning.triggers.service;
...
import net.plavcak.tutorial.tutorial.jpa.versioning.triggers.model.CustomerOrder;
import net.plavcak.tutorial.tutorial.jpa.versioning.triggers.model.Product;
import net.plavcak.tutorial.tutorial.jpa.versioning.triggers.repository.CustomerOrderRepository;
import net.plavcak.tutorial.tutorial.jpa.versioning.triggers.repository.CustomerRepository;
import net.plavcak.tutorial.tutorial.jpa.versioning.triggers.repository.ProductRepository;
