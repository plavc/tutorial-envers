...
@SpringBootTest(properties = "spring.jpa.properties.hibernate.integration.envers.enabled=false")
class BenchmarkInsertEnversDisabledTest extends BenchmarkInsertTest{
